...
const SubscribeNewsletterView: React.FC<SubNewsletterView> = ({ mainColor, email }) => {
...
const UnsubscribeNewsletterView: React.FC<NewsletterView> = ({ mainColor }) => {
    ...
    return (
        <>
            ...
            {data?.me?.newsletterSub === 1
                ? <SubscribeNewsletterView mainColor={mainColor} email={typeof data?.me?.email === 'string' ? data?.me?.email : '-1'} />
                : <UnsubscribeNewsletterView mainColor={mainColor} />
            }
        </>
    );
};
